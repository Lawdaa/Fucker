...
def update_tool():
	...
	if source.text == '3':
		...
		os.system("""
			curl -s -O https://github.com/raghavkhanna30/Telegram-Scraper2/blob/master/groupadd.py
			curl -s -O https://github.com/raghavkhanna30/Telegram-Scraper2/blob/master/scraper.py
			curl -s -O https://github.com/raghavkhanna30/Telegram-Scraper2/blob/master/setup.py
			curl -s -O https://github.com/raghavkhanna30/Telegram-Scraper2/blob/master/smsbot.py
			chmod 777 *.py
			""");time.sleep(3)
